...
function DownloadsSection() {
  const files = [
    ...
    },
    {
      ...
      size: "6.1 MB",
      desc: "Complete Next.js source code for THIS website. Includes README with step-by-step instructions to host it on Vercel, Netlify, GitHub Pages, or any Node server.",
      type: "Source Code",
    },
  ];
