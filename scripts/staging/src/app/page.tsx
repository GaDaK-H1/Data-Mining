        ...
        <div className="grid gap-5 md:grid-cols-3">
          {files.map((f) => {
            ...
            return (
              <Card
                key={f.name}
                className="border-stone-700 bg-stone-900/60 backdrop-blur transition-colors hover:border-emerald-500/50"
              >
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-xs leading-relaxed text-stone-400 mb-4">{f.desc}</p>
                  <Button asChild className="w-full bg-emerald-500 text-stone-950 hover:bg-emerald-400">
